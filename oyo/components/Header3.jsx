...
//           Over 157,000 hotels and homes around 35 countries
//         </h2>
//         <div className="grid grid-cols-5 my-5 mx-20">
//           <input
//             type="text"
//             placeholder="Search ..."
//             className=" h-16 outline-none px-5 text-lg border-r-2 border-gray-400 col-span-2"
//           />
//           <input
//             type="text"
//             placeholder="Search ..."
//             className=" h-16 outline-none px-5 text-lg  border-r-2 border-gray-400 col-span-1"
//           />
//           <input
//             type="text"
//             placeholder="Search ..."
...
//             <button
//               type="submit"
//               className="h-16 px-3 py-2 cols-span-1 bg-green-400 hover:cursor-pointer hover:bg-green-600 text-white text-xl"
//             >
//               Search
//             </button>
//           </Link>
...
//           <button
//             type="submit"
//             className="h-16 px-3 py-2  hover:cursor-pointer border-2 border-white text-white mr-5"
//           >
//             Continue your search
//           </button>
//           <button
